    ...
    photoAssets: [
      {
        ...
        resolutions: {
          mobile: {
            width: 480,
            height: 600,
            storagePath: `products/${PRODUCT_ID}/${IMAGE_ID}/mobile.webp`,
            downloadUrl: "https://ex.com/mobile.webp",
            format: "webp",
          },
          tablet: {
            width: 768,
            height: 960,
            storagePath: `products/${PRODUCT_ID}/${IMAGE_ID}/tablet.webp`,
            downloadUrl: "https://ex.com/tablet.webp",
            format: "webp",
          },
          desktop: {
            width: 1200,
            height: 1500,
            storagePath: `products/${PRODUCT_ID}/${IMAGE_ID}/desktop.webp`,
            downloadUrl: "https://ex.com/desktop.webp",
            format: "webp",
          },
        },
        createdAt: now,
