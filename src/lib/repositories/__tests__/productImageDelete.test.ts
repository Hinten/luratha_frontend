    ...
    photoAssets: [
      {
        ...
        alt: null,
        resolutions: {
          mobile: { width: 480, height: 600, storagePath: `products/${PRODUCT_ID}/${IMAGE_ID}/mobile.webp`, downloadUrl: "https://ex.com/mobile.webp", temporaryUrl: null, format: "webp" },
          tablet: { width: 768, height: 960, storagePath: `products/${PRODUCT_ID}/${IMAGE_ID}/tablet.webp`, downloadUrl: "https://ex.com/tablet.webp", temporaryUrl: null, format: "webp" },
          desktop: { width: 1200, height: 1500, storagePath: `products/${PRODUCT_ID}/${IMAGE_ID}/desktop.webp`, downloadUrl: "https://ex.com/desktop.webp", temporaryUrl: null, format: "webp" },
        },
        createdAt: now,
        updatedAt: now,
      },
