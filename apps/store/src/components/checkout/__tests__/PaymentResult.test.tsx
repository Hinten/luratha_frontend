...
describe("PaymentResult", () => {
  ...
  it("shows statusDetail and retry button for a failed card payment when onTryAgain is provided", () => {
    ...
    expect(screen.getByText("Cartão recusado pelo banco.")).toBeInTheDocument();
