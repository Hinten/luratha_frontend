#!/usr/bin/env node
// This file is superseded by docs/create-catalog-routes.mjs
// Run: npm run setup:routes
// (which executes docs/create-catalog-routes.mjs)
import("./create-catalog-routes.mjs");
/*
 * DEPRECATED – kept for reference only.
 * Original content had duplicate variable declarations that caused errors.
 *
...
// ─── page content ─────────────────────────────────────────────────────────────
// Note: uses string concatenation to avoid backtick-inside-template-literal issues.
...
const categoriaPage = `import { notFound } from "next/navigation";
import { Suspense } from "react";
import type { Metadata } from "next";
import { CATEGORIES } from "@/src/lib/constants";
import { buildMockProducts } from "@/src/lib/repositories/productsMockData";
...
console.log("\n🛍️  Luratha — setting up catalog route files\n");
